...
//  cout<<theta<<endl;
 // while (ros::ok())
 // {
    std_msgs::Float64 psm_msg1,psm_msg2,psm_msg3,psm_msg4,psm_msg5,psm_msg6,psm_msg7,psm_msg8,psm_msg9,psm_msg10;
    ...
    psm_msg7.data = theta_psm(0,6);
    psm_msg8.data = theta_psm(0,7);
    psm_msg9.data = theta_psm(0,8);
    psm_msg10.data = theta_psm(0,9);
    ...
    psm_pub7.publish(psm_msg7);
    psm_pub8.publish(psm_msg8);
    psm_pub9.publish(psm_msg9);
    psm_pub10.publish(psm_msg10);
...
int main(int argc, char**argv)
{
  ...
  for (int count=0;count<10001;count++)
  {
    ...
    angles_psm(0,2)=psm_angle(0,2);
    angles_psm(0,1)=psm_angle(0,1);
    // angles_psm(0,2)=psm_angle(0,1);
